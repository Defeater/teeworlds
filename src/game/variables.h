...
//infection
MACRO_CONFIG_INT(SvGameDelay, sv_game_delay, 10, 2, 60, CFGFLAG_SERVER, "Delay before the first human gets infected")
...
MACRO_CONFIG_INT(SvProtected, sv_spawn, 1, 0, 1, CFGFLAG_SERVER, "spawn protection?")
